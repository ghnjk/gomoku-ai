...
def syncToDrvier():
    print("%s start to sync to driver." % (now_string()))
    os.system("cp ./data/loss_data.txt '../driver/colab/gomoku-ai/data/'")
    os.system("cp ./data/model.json '../driver/colab/gomoku-ai/data/'")
    os.system("cp ./data/train_data.db '../driver/colab/gomoku-ai/data/'")
    os.system("cp ./data/train_data.db.index '../driver/colab/gomoku-ai/data/'")
    os.system("cp ./data/weight.hdf5 '../driver/colab/gomoku-ai/data/'")
    os.system("cp ./data/train_data.db.train.tmp '../driver/colab/gomoku-ai/data/'")
    print("%s end to sync to driver." % (now_string()))
...
def syncDriverJob():
    try:
        ...
        # if sleepTi < 10:
        #    sleepTi = 10
        # print("syncToDrvier use", ti, "will sleep ", sleepTi)
        # time.sleep(sleepTi)
    except Excetion as e:
        print("sync_driver_job exception: ", str(e))
